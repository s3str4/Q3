...
pitched down 42% (about 9 semitones, formants included) then brought back to pace by a WSOLA time compression, a +6 dB low shelf, lightly saturated, given a short arena slap-back and a 6.5 kHz roll-off (the Q3 register, without
